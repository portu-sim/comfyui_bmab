...
def get_color_name(color):
	...
	for i, lst in enumerate(named_color):
		if color == "#" + lst[0]:
			return "#" + lst[0], lst[1], True

		name_rgb = lst[2:5]
		name_hsl = lst[5:]
		ndf1 = sum((a - b) ** 2 for a, b in zip(rgb, name_rgb))
		ndf2 = sum((a - b) ** 2 for a, b in zip(hsl, name_hsl))
...
for c in named_color:
	code = '#' + c[0]
	c.extend(hex_to_rgb(code))
	c.extend(hex_to_hsl(code))
